...
Functions:
1. Predictive Uncertainty Quantification: This function evaluates the uncertainty of 
   predictions made by machine learning models.
2. Upset Detection: This function identifies anomalies and deviations in the predictions 
